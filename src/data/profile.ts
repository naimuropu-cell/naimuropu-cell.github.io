const profile = {
  name: "Md. Naimur Rahman Apu",

  title: "Junior Software QA Engineer",

  tagline:
    "Manual Testing • Automation Testing • API Testing • Performance Testing • QA Documentation",

  location: "Dhaka, Bangladesh",

  email: "naimuropu@gmail.com",
